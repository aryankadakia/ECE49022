...
HD_PWD='/home/shay/a/kadakia0/ECE49022/zedboard/blinky/blinky.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log blinky_sv.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source blinky_sv.tcl -notrace
